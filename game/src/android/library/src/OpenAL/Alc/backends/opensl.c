...
#include "AL/alslbridge.h"	// add by r-kishi
...
SLObjectItf g_objEngine_OnOpenAlBackend;
SLEngineItf g_engineEngine_OnOpenAlBackend;
SLObjectItf g_objOutputMix_OnOpenAlBackend;
void alslbridge_getOpenSlInterfaceToOpenAlBackend(SLObjectItf* objEngine, SLEngineItf* engineEngine, SLObjectItf* objOutputMix)
{
	*objEngine = g_objEngine_OnOpenAlBackend;
	*engineEngine = g_engineEngine_OnOpenAlBackend;
	*objOutputMix = g_objOutputMix_OnOpenAlBackend;
}
void alslbridge_setOpenSlInterfaceToOpenAlBackend(SLObjectItf objEngine, SLEngineItf engineEngine, SLObjectItf objOutputMix)
{
	g_objEngine_OnOpenAlBackend = objEngine;
	g_engineEngine_OnOpenAlBackend = engineEngine;
	g_objOutputMix_OnOpenAlBackend = objOutputMix;
}
#endif
...
#if USE_EXTERNAL_ENGINE_INSTANCE
	data->engineObject = g_objEngine_OnOpenAlBackend;
	data->engine = g_engineEngine_OnOpenAlBackend;
	data->outputMix = g_objOutputMix_OnOpenAlBackend;
#else	// USE_EXTERNAL_ENGINE_INSTANCE
    // create engine
...
static ALCboolean opensl_reset_playback(ALCdevice *Device)
{
    ...
    format_pcm.endianness = SL_BYTEORDER_LITTLEENDIAN /*SL_BYTEORDER_NATIVE*/;
