...
#ifndef _SRCR_FIXED_SYS_STR_TBL_H_
#define _SRCR_FIXED_SYS_STR_TBL_H_
...
public:
	enum
	{
		...
		SID_SOUMA_ESCR_SOURCE_ERROR_MSG			= 6702,	// "ソースが正しくなかった。%s"
		...
		SID_GUI_CAP_GO_BACK_TO_TITLE			= 8741,
		SID_GUI_CONFIRM_GO_BACK_TO_TITLE		= 8742,
		...
		SID_GUI_MENU_OPT_MOVMSG_WINDOW_MODE		= 8931,
		SID_GUI_MENU_OPTFLAGS_WAIT				= 8932,
		SID_GUI_MENU_OPTFLAGS_AUTOFLOW			= 8933,
...
public:
	...
	{
		#if defined(_DEBUG)
			const StringTable* strtblSys = FixedData::getFixedSystemStringTable();
			if(strtblSys == 0)
			{
...
#endif	// _SRCR_FIXED_SYS_STR_TBL_H_
