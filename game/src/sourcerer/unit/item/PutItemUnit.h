...
#ifndef _SRCR_UNIT_ITEM_PUT_ITEM_UNIT_H_
#define _SRCR_UNIT_ITEM_PUT_ITEM_UNIT_H_
 ...
 *
**//*---------------------------------------------------------------------*/
class PutItemUnit : public ItemUnit
{
	//======================================================================
	// 定数
public:
...
protected:
	...
	f32					_thetaMapMark;			// マップ記号の回転角（ラジアン）
	f32					_uvarrMapMark[8];		// マップ記号のテクスチャ座標
...
#endif	// _SRCR_UNIT_ITEM_PUT_ITEM_UNIT_H_
