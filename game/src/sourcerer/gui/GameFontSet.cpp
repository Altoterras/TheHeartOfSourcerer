...
/*---------------------------------------------------------------------*//**
	指定フォントを得る
**//*---------------------------------------------------------------------*/
Font* GameFontSet::getFont(s32 fonttype) const
{
	if((fonttype < 0) || (fonttype >= NUM_))	{	return 0L;	}
	ASSERT(_fontarr[fonttype] != 0L);
...
**//*---------------------------------------------------------------------*/
Texture* GameFontSet::getTexture(s32 fonttype) const
{
	if((fonttype < 0) || (fonttype >= NUM_))	{	return 0L;	}
