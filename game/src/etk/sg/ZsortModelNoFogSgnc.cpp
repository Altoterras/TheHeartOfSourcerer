...
/*---------------------------------------------------------------------*//**
	コンストラクタ
**//*---------------------------------------------------------------------*/
ZsortModelNoFogSgnc::ZsortModelNoFogSgnc()
	: _numMdl(0)
{
...
/*---------------------------------------------------------------------*//**
	描画前処理
**//*---------------------------------------------------------------------*/
void ZsortModelNoFogSgnc::previseImplements(const RenderCtx* rc)
{
	// モデル数を得る
...
/*---------------------------------------------------------------------*//**
	描画
**//*---------------------------------------------------------------------*/
void ZsortModelNoFogSgnc::renderImplements(const RenderCtx* rc)
{
...
/*---------------------------------------------------------------------*//**
	クイックソート比較関数
**//*---------------------------------------------------------------------*/
int ZsortModelNoFogSgnc::compare(const Qsdat* a, const Qsdat* b)
{
