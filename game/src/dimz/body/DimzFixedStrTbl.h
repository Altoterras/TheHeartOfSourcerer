...
#ifndef _DIMZ_BODY_DIMZ_FIXED_STR_TBL_H_
#define _DIMZ_BODY_DIMZ_FIXED_STR_TBL_H_
...
public:
	...
	{
		#if defined(_DEBUG)
			const StringTable* strtblSys = DimzFixedData::getFixedSystemStringTable();
			if(strtblSys == 0)
			{
...
#endif	// _DIMZ_BODY_DIMZ_FIXED_STR_TBL_H_
