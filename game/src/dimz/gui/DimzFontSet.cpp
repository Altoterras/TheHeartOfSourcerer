...
/*---------------------------------------------------------------------*//**
	指定フォントを得る
**//*---------------------------------------------------------------------*/
Font* DimzFontSet::getFont(s32 fonttype) const
{
...
**//*---------------------------------------------------------------------*/
Texture* DimzFontSet::getTexture(s32 fonttype) const
{
	if((fonttype < 0) || (fonttype >= NUM_))	{	return 0L;	}
