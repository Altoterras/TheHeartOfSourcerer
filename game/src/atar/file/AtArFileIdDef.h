...
#ifndef _ATAR_FILE_AT_AR_FILE_ID_DEF_H_
#define _ATAR_FILE_AT_AR_FILE_ID_DEF_H_
...
#define FILEID_CONV_WD(fid_)					((fid_) + (Env_isWdResolution() ? 30 : Env_isRdResolution() ? 20 : Env_isHdResolution() ? 10 : 0))
...
#endif	// _ATAR_FILE_AT_AR_FILE_ID_DEF_H_
