...
/*---------------------------------------------------------------------*//**
	ファンクションキーによるテスト実行
**//*---------------------------------------------------------------------*/
void AtArTest::onKeydownFunctionKey(s32 funckey)
{
	switch(funckey)
	{
	case 1:		// F1
...
/*---------------------------------------------------------------------*//**
	作成
**//*---------------------------------------------------------------------*/
bool AtArTest::create(f32 spfRender, f32 spfLogic)
{
	// パフォーマンスメーターの作成
...
/*---------------------------------------------------------------------*//**
	フレーム制御
**//*---------------------------------------------------------------------*/
void AtArTest::exec(ExecRes* res, const ExecCtx* ec)
{
...
//	if(_subtest != 0L)	{	_subtest->exec(res, ec);	}
	...
	// デモ
		...
		{
			AtArParticleSys* ptclsys = (AtArParticleSys*)EtkBody::getBody()->getParticleSys();
...
/*---------------------------------------------------------------------*//**
	3D 描画
**//*---------------------------------------------------------------------*/
void AtArTest::render(const RenderCtx* rc)
{
...
/*---------------------------------------------------------------------*//**
	2D 描画
**//*---------------------------------------------------------------------*/
void AtArTest::draw(const RenderCtx* rc)
{
