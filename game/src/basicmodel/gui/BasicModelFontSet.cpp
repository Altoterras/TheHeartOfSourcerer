...
//==========================================================================
// BasicModelFontSet プロパティ

/*---------------------------------------------------------------------*//**
	指定フォントを得る
**//*---------------------------------------------------------------------*/
Font* BasicModelFontSet::getFont(s32 fonttype) const
{
...
**//*---------------------------------------------------------------------*/
Texture* BasicModelFontSet::getTexture(s32 fonttype) const
{
	if((fonttype < 0) || (fonttype >= NUM_))	{	return 0L;	}
...
//==========================================================================
// BasicModelFontSet メソッド
	
/*---------------------------------------------------------------------*//**
	コンストラクタ
**//*---------------------------------------------------------------------*/
BasicModelFontSet::BasicModelFontSet()
	: _fontarr(0L)
	, _texarrBmpFont(0L)
	, _pfdatarrFont(0L)
	, _fcddJpFont(0L)
...
/*---------------------------------------------------------------------*//**
	破棄
**//*---------------------------------------------------------------------*/
void BasicModelFontSet::destroy()
{
	// 日本語フォントの文字定義データ削除
	delete _fcddJpFont;
	_fcddJpFont = 0L;
...
/*---------------------------------------------------------------------*//**
	フォント再読込（デバッグ用）
**//*---------------------------------------------------------------------*/
void BasicModelFontSet::debug_reload()
{
	// テクスチャ配列の削除
	if(_texarrBmpFont != 0L)
	{
