...
#ifndef _BASICMODEL_BODY_BASICMODEL_FIXED_STR_TBL_H_
#define _BASICMODEL_BODY_BASICMODEL_FIXED_STR_TBL_H_
...
public:
	...
	{
		#if defined(_DEBUG)
			const StringTable* strtblSys = BasicModelFixedData::getFixedSystemStringTable();
			if(strtblSys == 0)
			{
...
#endif	// _BASICMODEL_BODY_BASICMODEL_FIXED_STR_TBL_H_
